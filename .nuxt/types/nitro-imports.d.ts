...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/opt/apps/hermes-webui/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/opt/apps/hermes-webui/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';